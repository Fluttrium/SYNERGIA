        ...
        <div className="flex flex-col text-center mb-0">
          <div className="mx-7 mb-0">
            ...
            <p className="text-center text-base md:text-lg lg:text-xl w-full md:w-3/4 lg:w-2/3 mx-auto mb-0">
              Важное место во внешних связях Санкт&#8209;Петербурга занимает
              сотрудничество с зарубежными городами и регионами, начало которым
              было положено в 1953 году, когда были установлены связи с финским
              городом Турку. В настоящее время 93 зарубежных города и 30
              зарубежных регионов имеют двусторонние документы о сотрудничестве
              с Санкт&#8209;Петербургом.
            </p>
          </div>
        </div>
