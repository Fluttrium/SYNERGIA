                                        ...
                                        <div className="space-y-10">
                                            ...
                                            <div className="flex-col justify-center items-center">
                                                <button
                                                    id="submit-button"
                                                    type="submit"
                                                    className={`text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:ring-purple-600 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-600 ${isChecked ? "" : "opacity-50 cursor-not-allowed"}`}
                                                    disabled={!isChecked}
                                                >
                                                    Отправить письмо
                                                </button>
