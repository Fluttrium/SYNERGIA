    ...
    <section className="relative bg-black h-50 text-white">
          <div className="container mx-auto px-4 py-8 md:grid md:grid-cols-3 md:gap-8">
            ...
            <div className="hidden md:block">
              ...
              <p className="text-sm mt-2">
                Фонд развития культурно-делового сотрудничества
            городов-побратимов&#8194;
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 mr-40 md:gap-8 lg:col-span-2">
                  <div className="footer-column flex flex-col md:col-span-start">
            {" "}
            {/* Изменено */}
                  ...
                  <div className="footer-column flex flex-col md:col-span-1">
            {" "}
            {/* Изменено */}
                      <p className="text-xl font-bold pb-2 text-left pr-16">Фонд</p>{" "}
            {/* Изменено */}
      ...
      <hr className="bg-white/50 h-0.5" />
        ...
        <div className="flex items-center">
          ...
          <a href="http://fluttrium.ru/" target="_blank" rel="noopener noreferrer">
            <Image src="/logo/image-removebg-preview.png" alt="Logo" width={150} height={150} />
          </a>
        </div>
          </div>
